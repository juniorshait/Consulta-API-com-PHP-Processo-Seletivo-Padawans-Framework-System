...
<body style="background-color:#d4dadd;">
    <div style="margin-left:40%; margin-top:6%;">
        <h1 style="font-style: italic;">Tabela <span style="color:rgb(71, 197, 65); font-style: italic;">TO-DOs</span></h1>
    </div>
    ...
    <tr align='center'>
      ...
      <th scope='col'style='color:white;'>Status Tarefa</th>
    </tr>
  </thead>";
    ...
    foreach ($api as $key => $value) {
        ...
        if ($value->completed != 1) {
            echo "<td align='center' style='color:red;'><div class='form-check form-switch'>
            <input class='form-check-input' type='checkbox' id='flexSwitchCheckDefault'>
            <label class='form-check-label' for='flexSwitchCheckDefault'>Não realizado -> false</label>
          </div></td>";
        } else {
            echo "<td align='center'><div class='form-check form-switch'>
            <input  class='form-check-input' type='checkbox' id='flexSwitchCheckCheckedDisabled' checked disabled>
            <label class='form-check-label' style='color:#00e34f;' for='flexSwitchCheckCheckedDisabled'>Completado -> true</label>
          </div></td>";
        }
